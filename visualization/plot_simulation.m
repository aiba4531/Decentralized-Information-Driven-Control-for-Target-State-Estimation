function plot_simulation(target_state, agents, params, t)
    ...
    legend([h_target, h_ground1, h_ground2, h_air, h_meas, h_estimate, h_cov], ...
           {'True Target', 'Ground Agent 1', 'Ground Agent 2', 'Aerial Agent', ...
